...
여러 명의 사용자가 방에 들어와서 그림을 그리게 되고 사용자가 많아지면 여러 개의 커서가 생기게 됩니다. 그렇게 되면 사용자가 잠시 그림을 그리는 것을 쉬게 되더라도 커서는 화면 위에 표시되게 됩니다. 그 부분이 사용자 입장에서 불편할 수 있는 부분이라 생각했습니다. 움직임이 없는 상태로 5초가 지나게 되면 커서를 보이지 않게 만드는 기능을 [Redux에서 count 변수를 관리](https://github.com/MotionDraw/MotionDraw-Client/blob/f0008a75ca7b9681855fa13ad06d1702c4e7b698/src/features/history/cursorSlice.js#L4) 하여 구현했습니다.
